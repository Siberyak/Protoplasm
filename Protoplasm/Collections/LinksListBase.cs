...
namespace Protoplasm.Collections
{
		...
		where TLink : ILink<TOwner, TRelated>
	{
        ...
        protected LinksListBase(TOwner owner, Func<TOwner, TRelated, TLink> createNewLink, Func<TLink, bool> deleteLink, bool processIBindingListItem = true)
			: base(link => link.Related, null, processIBindingListItem)
		{
			Owner = owner;
        ...
        protected LinksListBase(TOwner owner, IList<TLink> baseList, Func<TOwner, TRelated, TLink> createNewLink, Func<TLink, bool> deleteLink, bool processIBindingListItem = true)
			: base(baseList, link => link.Related, null, processIBindingListItem)
		{
			Owner = owner;
			_createNewLink = createNewLink;
			_deleteLink = deleteLink;
